...
public:
	...
	HRESULT CreateResource( ID3D11Device* pd3dDevice )
	{
		...
		V_RETURN(DXUTCompileFromFile(L"TSDFImages.hlsl", nullptr, "CS_KinectView", "cs_5_0", COMPILE_FLAG, 0, &pCSBlob));
		...
		V_RETURN(DXUTCompileFromFile(L"TSDFImages.hlsl", nullptr, "CS_FreeView", "cs_5_0", COMPILE_FLAG, 0, &pCSBlob));
		...
		V_RETURN(DXUTCompileFromFile(L"TSDFImages.hlsl", nullptr, "CS_Raycast", "cs_5_0", COMPILE_FLAG, 0, &pCSBlob));
